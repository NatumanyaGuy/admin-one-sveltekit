<section class="section main-section min-h-screen">
	<div class="card">
			...
			<form method="get">
				<div class="field spaced">
					...
					<div class="control icons-left">
						...
						/>
						<span class="icon is-small left"><i class="mdi mdi-account" /></span>
					</div>
				...
				<div class="field spaced">
					...
					<p class="control icons-left">
						...
						/>
						<span class="icon is-small left"><i class="mdi mdi-asterisk" /></span>
					</p>
