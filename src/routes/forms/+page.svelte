<script>
	import TitleBar from '$lib/Dashboard/TitleBar.svelte';
	import Notification from '$lib/UI/Notification.svelte';
</script>

<TitleBar _page="Tables" />
<Notification _color="green" />
...
<section class="section main-section">
					...
					<div class="field-body">
						<div class="field">
							<div class="control icons-left">
								...
								<span class="icon left"><i class="mdi mdi-account" /></span>
							</div>
						</div>
						<div class="field">
							<div class="control icons-left icons-right">
								<input class="input" type="email" placeholder="Email" value="alex@smith.com" />
								<span class="icon left"><i class="mdi mdi-mail" /></span>
								<span class="icon right"><i class="mdi mdi-check" /></span>
							</div>
						</div>
					</div>
				</div>
	...
	<div class="card">
		<header class="card-header">
			<p class="card-header-title">
				<span class="icon"><i class="mdi mdi-ballot-outline" /></span>
				Custom elements
			</p>
		</header>
		<div class="card-content">
					...
					<div class="field grouped multiline">
						<div class="control">
							<label class="checkbox"
								><input type="checkbox" value="lorem" checked />
								<span class="check" />
						...
						<div class="control">
							<label class="checkbox"
								><input type="checkbox" value="dolore" />
