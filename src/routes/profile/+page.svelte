	...
	<div class="grid grid-cols-1 gap-6 lg:grid-cols-2 mb-6">
		<div class="card">
			...
			<div class="card-content">
				<form>
					<div class="field">
						<label class="label" for="">Avatar</label>
						<div class="field-body">
							<div class="field file">
								<label class="upload control">
									<a href="/" class="button blue"> Upload </a>
									<input type="file" />
								</label>
							</div>
						</div>
					...
					<div class="field">
						...
						<div class="field-body">
							<div class="field">
								<div class="control">
									<input type="text" autocomplete="on" name="name" value="John Doe" class="input" />
								</div>
		...
		<div class="card">
			...
			<div class="card-content">
				...
				<div class="field">
					<label class="label" for="">Name</label>
					<div class="control">
						<input type="text" value="John Doe" class="input is-static" />
					</div>
				</div>
				<hr />
				<div class="field">
					<label class="label" for="">E-mail</label>
					<div class="control">
						<input type="text" value="user@example.com" class="input is-static" />
					</div>
				</div>
			</div>
		</div>
